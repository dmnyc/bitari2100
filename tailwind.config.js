  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'crt-on': {
          '0%':   { transform: 'scaleY(0.005) scaleX(0)', filter: 'brightness(30)' },
          '40%':  { transform: 'scaleY(0.005) scaleX(1)', filter: 'brightness(10)' },
      ...
      boxShadow: {
        'crt-glow':   '0 0 60px rgba(92, 156, 92, 0.3), inset 0 0 60px rgba(0,0,0,0.4)',
