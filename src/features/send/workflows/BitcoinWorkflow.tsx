...
const BitcoinWorkflow: React.FC<BitcoinWorkflowProps> = ({
  method,
  amountSats,
  onBack,
  onSend,
  ...
  const handleSend = async () => {
    ...
    await onSend({
      type: "bitcoinAddress",
      confirmationSpeed: selectedFeeRate,
    });
  };
  ...
  return (
    <StepPanelGroup>
      ...
      <StepPanel isActive={step === "fee"}>
        <div className="mb-4">
          <label className="block text-lg font-medium text-[rgb(var(--text-white))] mb-2">
            Select Fee Rate
          </label>
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              disabled={false}
              className={`relative p-3 rounded-lg border text-lg font-medium transition-colors ${
            ...
            >
              ...
              <div className="text-base opacity-70">
                {fq.speedSlow.l1BroadcastFeeSat + fq.speedSlow.userFeeSat}
              </div>
            </button>
            <button
            ...
            >
              ...
              <div>Medium</div>
              <div className="text-base opacity-70">
                {fq.speedMedium.l1BroadcastFeeSat + fq.speedMedium.userFeeSat}
              </div>
            </button>
            <button
            ...
            >
              ...
              <div>Fast</div>
              <div className="text-base opacity-70">
                {fq.speedFast.l1BroadcastFeeSat + fq.speedFast.userFeeSat}
              </div>
            </button>
          </div>
        </div>
