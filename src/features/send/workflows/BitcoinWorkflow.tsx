  ...
  return (
    <StepPanelGroup>
      ...
      <StepPanel isActive={step === 'fee'}>
        <div className="mb-4">
          <label className="block text-lg font-medium text-[rgb(var(--text-white))] mb-2">Select Fee Rate</label>
          <div className="grid grid-cols-3 gap-2">
            <button
              onClick={() => setSelectedFeeRate('slow')}
              disabled={false}
              className={`relative p-3 rounded-lg border text-lg font-medium transition-colors ${selectedFeeRate === 'slow'
            ...
            >
              ...
              <div>Slow</div>
              <div className="text-base opacity-70">{fq.speedSlow.l1BroadcastFeeSat + fq.speedSlow.userFeeSat} sats</div>
            </button>
            <button
              onClick={() => setSelectedFeeRate('medium')}
              disabled={false}
              className={`relative p-3 rounded-lg border text-lg font-medium transition-colors ${selectedFeeRate === 'medium'
                ? 'bg-[rgb(var(--primary-blue))] text-white border-[rgb(var(--primary-blue))] ring-2 ring-[rgb(var(--primary-blue))]'
                : 'bg-[rgb(var(--card-bg))] text-[rgb(var(--text-white))] border-[rgb(var(--card-border))] hover:border-[rgb(var(--primary-blue))]'
                }`}
            >
              ...
              <div>Medium</div>
              <div className="text-base opacity-70">{fq.speedMedium.l1BroadcastFeeSat + fq.speedMedium.userFeeSat} sats</div>
            </button>
            <button
              onClick={() => setSelectedFeeRate('fast')}
              disabled={false}
              className={`relative p-3 rounded-lg border text-lg font-medium transition-colors ${selectedFeeRate === 'fast'
                ? 'bg-[rgb(var(--primary-blue))] text-white border-[rgb(var(--primary-blue))] ring-2 ring-[rgb(var(--primary-blue))]'
                : 'bg-[rgb(var(--card-bg))] text-[rgb(var(--text-white))] border-[rgb(var(--card-border))] hover:border-[rgb(var(--primary-blue))]'
                }`}
            >
              ...
              <div>Fast</div>
              <div className="text-base opacity-70">{fq.speedFast.l1BroadcastFeeSat + fq.speedFast.userFeeSat} sats</div>
            </button>
          </div>
        </div>
